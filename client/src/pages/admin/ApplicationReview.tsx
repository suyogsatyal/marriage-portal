        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-1 max-w-3xl w-full mx-auto px-4 sm:px-6 py-8">
                ...
                {application.status === "approved" && (
                    <div className="flex gap-4 justify-end">
                        <Button className="bg-emerald-600 hover:bg-emerald-700" onClick={() => navigate("/admin/certificate/" + id)}>
                            Generate Cerificate
                        </Button>
                    </div>
                )}
            ...
            <Dialog open={!!dialogOpen} onOpenChange={() => setDialogOpen(false)}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{dialogOpen === "approve" ? "Confirm Approval" : "Confirm Rejection"}</DialogTitle>
                        <DialogDescription>
                            Are you sure you want to {dialogOpen === "approve" ? "approve" : "reject"} this application? This action
                            cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter className="mt-4">
                        ...
                        <Button
                            ...
                            disabled={loading}
                            onClick={() => dialogOpen && handleConfirm(dialogOpen === "approve" ? "approved" : "rejected")}
                        >
